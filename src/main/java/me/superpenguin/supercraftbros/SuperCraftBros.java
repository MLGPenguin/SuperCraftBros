...
public class SuperCraftBros extends JavaPlugin {
	...
	public static Inventory getKitInventory(int page) { 
		...
		List<kitType> t = new KitSorter(new ArrayList<>(ClassSelector.keySet()), KitSorter.SortingOrder.RARITY).getSorted();
