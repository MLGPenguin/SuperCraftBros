...
import me.Penguin.SuperCraftBros.guis.SelectKit;
import me.Penguin.SuperCraftBros.objects.GUI;
import me.Penguin.SuperCraftBros.objects.GUI.GUIType;
...
import me.Penguin.SuperCraftBros.utils.ScoreboardUtil;
...
public class MainListener implements Listener{
	...
	public void InventoryClick(InventoryClickEvent e) {
		...
		if (Main.viewingGUI.containsKey(uuid)) {
			...
			if (gui.getType() != GUIType.CRAFTING) e.setCancelled(true);
	...
	public void onDie(PlayerDeathEvent e) {		
		...
		if (g != null) {
			if (g.getState() == gamestate.ONGOING) {		
	...
	public void preventHatching(PlayerEggThrowEvent e) {
		...
		if (s != null && s.hasKit()) {
			if (s.getKit().getType().equals(kitType.CHICKEN)) e.setHatching(false);
		}
	}
